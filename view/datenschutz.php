...
<body>
    ...
    <main class="main-datenschutz">
        ...
        <p>
            Unsere Website wird von HOSTER_FIRMA (HOSTER_ADRESSE) gehostet. <br> 
            Zur Optimierung und Aufrechterhaltung unserer Website protokollieren wir technische Fehler, die beim Aufrufen unserer Website allenfalls auftreten. Ferner werden bei der Nutzung dieser Website automatisch Informationen erhoben, die der Browser Ihres Endgeräts an unseren Host-Provider übermittelt. <br>
            Dies sind: IP-Adresse und Betriebssystem Ihres Endgeräts, Browsertyp, Version, Sprache, Datum und Uhrzeit der Serveranfrage, aufgerufene Datei, die Website, von der aus der Zugriff erfolgte (Referrer URL), den Status-Code (z.B. 404) und das verwendete Übertragungsprotokoll (z.B. HTTP/2).
            ...
            Weitere Informationen finden Sie in der Datenschutzerklärung der HOSTER_FIRMA unter HOSTER_URL_DATENSCHUTZ.
